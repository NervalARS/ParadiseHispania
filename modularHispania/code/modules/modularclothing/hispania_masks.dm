/obj/item/clothing/mask/thief
	...
	icon = 'modularHispania/icons/obj/clothing/masks.dmi'
	icon_state = "dallas"
	item_state = "dallas"
	item_color = "dallas"
	hispania_icon = TRUE
...
/obj/item/clothing/mask/gas/sechailer/cloaker
	...
	hispania_icon = TRUE
	sprite_sheets = list(
	"Vox" = 'modularHispania/icons/mob/species/vox/mask.dmi',
	"Grey" = 'modularHispania/icons/mob/species/grey/mask.dmi',
	"Unathi" = 'modularHispania/icons/mob/species/unathi/mask.dmi',
	"Drask" = 'modularHispania/icons/mob/species/drask/mask.dmi',
	"Tajaran" = 'modularHispania/icons/mob/species/tajaran/mask.dmi')
